   ...
   <div class="container-referencia">
        ...
        <div class="content">
            ...
            <p style="text-align: justify;font-family: Verdana, Geneva, Tahoma, sans-serif;">
                ...
                <b>NIT 900162902-8</b> desde el {{$diacontrato}} de {{$mescontrato}} del año {{$aniocontrato}}, mediante la prestación de nuestros servicios {{$empresa->servicio}}, durante este tiempo han demostrado como clientes
