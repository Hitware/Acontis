   ...
   <div class="container-referencia">
       @foreach ($certificado as $certificado)
        <div class="content">
            <br>
            <br>
            <center><b style="font-family: Verdana, Geneva, Tahoma, sans-serif;">ASESORIAS CONTABLES DEL CARIBE SAS – ACONTIS 
                <br> NIT. 900162902 – 8                
            </b></center> 
            <br>
            <br>
            ...
            <p style="text-align: justify;font-family: Verdana, Geneva, Tahoma, sans-serif;">
                ...
                desempeñándose en el cargo de {{$certificado->cargo}}.  Con una asignación de ${{number_format($certificado->salario,0)}} (salario en letras).
            </p>
            <br>
            <br>
            <br>
